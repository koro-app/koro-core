...
describe('Service: ProductCartService', () => {
  let service: ProductCartService = null;
  ...
  beforeEach(inject([ProductCartService, MockBackend], (productCartService: ProductCartService, mockBackend: MockBackend) => {
